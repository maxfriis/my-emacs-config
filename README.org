...
I think which-key was made native in that version because I know the which-key package is much older.
...
Other states are also configured sensibly.
...
I often press =c= even before I have fully figured out what motion I need.
...
Last you might want to make a link to .emacs.d/ in the /root folder to use emacs as superuser.
