...
;; | #00f | shadow/hl-line  | #f0f | link/timestamp  |
;; |------+-----------------+------+-----------------|
;; state. Unspecified faces are handled by the vanilla theme.
;; ----------------------------------------------------------------------------
(set-face-attribute
 'default
...
(set-face-attribute
 'fringe
 nil :foreground "#00f" :background "#000")
(set-face-attribute
 'line-number
 nil :foreground "#00f" :background "#000" :height 0.8)
(set-face-attribute
 'line-number-current-line
 nil :foreground "#000" :background "#00f")
(set-face-attribute
 'mode-line
 nil :foreground "#000" :background "#00f" :box nil :height 0.8)
(set-face-attribute
 'mode-line-inactive
 nil :foreground "#00f" :background "#000" :box nil :overline t)
(set-face-attribute
 'tab-bar
 nil :foreground "#00f" :background "#000" :weight 'bold :box nil :inherit 'default :height 0.8)
(set-face-attribute
 'tab-bar-tab
 nil :foreground "#000" :background "#00f" :box t)
(set-face-attribute
 'tab-bar-tab-inactive
 nil :foreground "#00f" :background "#000" :box nil)
(with-eval-after-load 'tab-line
  (set-face-attribute
   'tab-line
   nil :foreground "#00f" :background "#000" :overline t :box nil)
  (set-face-attribute
   'tab-line-tab ;; active tab in another frame
   nil :inherit 'tab-line :box nil)
  (set-face-attribute
   'tab-line-tab-current
   nil :foreground "#000" :background "#00f" :box nil)
  (set-face-attribute
...
(with-eval-after-load 'org
  ...
  (set-face-attribute
   'org-footnote
   nil :foreground "#f0f" :underline nil :height 0.8)
  (set-face-attribute
   'org-date
   nil :foreground "#f0f" :underline nil :height 0.8)
  (set-face-attribute
...
(with-eval-after-load 'org-agenda
  ...
  (set-face-attribute
   'org-agenda-clocking
   nil :foreground "#0ff" :background "#00f")
  (set-face-attribute
   'org-agenda-date
   nil :foreground "#f0f" :background "#000" :box nil :weight 'normal)
  (set-face-attribute
   'org-agenda-date-weekend
   nil :foreground "#f0f" :background "#000" :box nil :weight 'normal :underline nil)
  (set-face-attribute
...
(with-eval-after-load 'org-superstar
  (set-face-attribute
   ...
   nil :foreground "#00f" :height 0.8) ; the dots marking the deapt
  (set-face-attribute
   'org-superstar-item
...
(with-eval-after-load 'org-habit
  (set-face-attribute
   ...
   nil :foreground "#f00" :background "#ff0" :weight 'bold :height 0.8)
  (set-face-attribute
  ...
  (set-face-attribute
   ...
   nil :foreground "#ff0" :background "#00f" :weight 'bold :height 0.8)
  (set-face-attribute
...
(with-eval-after-load 'rainbow-delimiters
  (set-face-attribute
   ...
   nil :foreground "#fff" :background "#f00" :weight 'bold :underline t)
  (set-face-attribute
...
(with-eval-after-load 'keycast
  (set-face-attribute
   'keycast-key
   nil :foreground "#000" :background "#00f" :box t :height 0.8))
...
(with-eval-after-load 'counsel
  (set-face-attribute
   ...
   nil :foreground "#0f0" :background "#00f"))
